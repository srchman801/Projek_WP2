...
<div class="container-fluid">
  ...
  <div class="card rounded-0 shadow mb-3">
    <div class="card-body">
      <fieldset class="border rounded-0 px-2 pb-2">
        <legend class="ml-3 px-3 w-auto">Filter Laporan</legend>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
              <select class="form-control form-control-sm rounded-0" name="dept">
                <option disabled>Departemen</option>
            ...
            <div class="col-2">
              <button type="submit" class="btn btn-primary btn-sm rounded-0 bg-gradient-primary "><i class="fa fa-file"></i> Tunjukkan Laporan</button>
            </div>
          </div>
        </form>
      </fieldset>
  ...
  <?php if ($attendance == false) : ?>
    <h3 class="text-center my-5">Pilih Departemen Dan Tanggal.</h3>
  <?php else : ?>
