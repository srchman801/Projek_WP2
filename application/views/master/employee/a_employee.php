          ...
          <div class="row justify-content-center">
            <div class="col-lg-10 p-0">
              ...
              <div class="card rounded-0">
                <h5 class="card-header">Tambahkan Karyawan Baru</h5>
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        <label for="d_id" class="col-form-label col-lg-4">Nama Departemen</label>
                        <div class="col p-0">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group row">
                        <label for="image" class="col-form-label col-lg-4">Foto Profil Karyawan</label>
                      ...
                      <div class="form-group row">
                        <label for="e_hire_date" class="col-form-label col-lg-4">Tanggal Direkrut</label>
                        <div class="col-lg p-0">
