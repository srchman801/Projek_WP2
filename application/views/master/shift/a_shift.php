          ...
          <div class="row justify-content-center">
            <form action="" method="POST" class="col-lg-5 col-md-6 col-sm-12 col-xs-12 p-0">
              <div class="card rounded-0">
                <h5 class="card-header">Tambahkan Shift Baru</h5>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="s_start_h" class="col-form-label-lg">Jam mulai shift</label>
                    <div class="row">
                      <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label for="s_end_h" class="col-form-label-lg">jam berakhir shift</label>
                    <div class="row">
                      <div class="col-sm-4">
