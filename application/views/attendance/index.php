       ...
       <div class="container-fluid">
         ...
         <div class="d-sm-flex align-items-center justify-content-between mb-4">
           <h1 class="h3 mb-0 text-gray-800">Formulir Kehadiran</h1>
         </div>
               ...
               <div class="col-xl-12 col-lg-7">
                 <div class="card shadow mb-4" style="min-height: 543px">
                   ...
                   <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                     <h6 class="m-0 font-weight-bold text-dark">Isi Kehadiranmu!</h6>
                   </div>
                   <!-- Card Body -->
                   <div class="card-body">
                       ...
                       <?php if ($in == false) : ?>
                         ...
                         <div class="row mb-3">
                           <div class="col-lg-5">
                             ...
                             <label for="work_shift" class="col-form-label">Shift Bekerja</label>
                           ...
                           <div class="col-lg-5 offset-lg-1">
                             <label for="location" class="col-form-label">Waktu Masuk</label>
                         ...
                         <div class="row mb-3">
                           ...
                           <div class="col-lg-5 offset-lg-1 text-center">
                             ...
                             <button type="submit" class="btn btn-primary bg-gradient-primary px-5 btn-lg rounded-pill" >
                               <i class="fas fa-fw fa-sign-in-alt"></i> Absen Masuk
                             </button>
                             <hr>
                           </div>
                         </div>
                         <?= form_close() ?>
                       <?php else : ?>
                         <h3 class="text-center my-3">TERIMA KASIH!</h3>
                         <h6 class="card-title text-center mb-4 px-4">SEMANGAT KERJANYA!</h6>
                         <?php if ($disable == false) : ?>
                           <div class="row">
                             <a href="<?= base_url('attendance/checkout') ?>" onclick="return confirm('Time Out now? Make sure you are done with you work!')" class="btn btn-danger bg-gradient-danger rounded-pill px-5 btn-lg mx-auto">
                               <i class="fas fa-fw fa-sign-out-alt"></i> <b>Absen Keluar</b>
                             </a>
                           <?php else : ?>
