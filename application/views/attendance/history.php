...
<div class="container-fluid">
  ...
  <div class="d-flex w-100 align-items-center">
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
      <h1 class="h3 mb-0 text-gray-800">Riwayat Kehadiran</h1>
    </div>
      ...
      <fieldset class="border rounded-0 px-2 pb-2">
        ...
        <form action="" method="GET">
          <div class="row">
            ...
            <div class="col-2">
              <button type="submit" class="btn btn-primary btn-sm rounded-0 bg-gradient-primary "><i class="fa fa-file"></i>Tunjukkan Kehadiran</button>
            </div>
          </div>
        </form>
      </fieldset>
